...
api.interceptors.request.use(function (config) {
  ...
  config.headers.common["Authorization"] =
    "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJKd3RUb2tlbiA6IG5hd2hnbm9lamlqQG5hdmVyLmNvbSIsImV4cGlyZURhdGUiOjE2NDc1MDMwNzYsInVzZXJuYW1lIjoibmF3aGdub2VqaWpAbmF2ZXIuY29tIn0.rES1NwdomPKEHITwWlt5HEKFptoT4H-nFPb7xIokSSE";
  // `${accessToken}`; // header에 토큰값을 넣는다 => header에 토큰값이 있어 앞으로 request를 자유자재로 할 수 있다.
  return config;
});
